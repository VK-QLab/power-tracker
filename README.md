...
3. **Первое включение:**
   ...
   - Подключиться к ней (пароль: `vk_testlab`)
...
В папке `stl`: корпус датчика INA231, корпус МК для HW364A
Подставку под телефон можно скачать [здесь|https://www.thingiverse.com/thing:7347796]
